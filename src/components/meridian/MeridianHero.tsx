...
export function MeridianHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-graphite pt-40 md:pt-56" data-section="MERIDIAN™ overview">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        ...
        <SplitText as="h1" text="MERIDIAN™" className="display mt-8 text-[clamp(3.25rem,14vw,13rem)]" immediate delay={0.3} />
        <SplitText
          as="p"
          text="One platform. Every asset. Every hectare. Every valuation."
          className="display-md mt-2 max-w-4xl text-[clamp(1.5rem,3.4vw,2.75rem)] text-warm/85"
          immediate
          delay={0.7}
        />
        <motion.div
      ...
      <div ref={ref} className="relative mx-auto mt-24 max-w-7xl px-6 pb-24 md:mt-32 md:px-10 md:pb-32">
        <div className="grid border border-hairline md:grid-cols-4">
          {READOUTS.map((r, i) => (
            <div key={r.label} className={`p-7 md:p-9 ${i > 0 ? 'border-t border-hairline md:border-l md:border-t-0' : ''}`}>
              ...
              <div className="readout mt-7 text-[clamp(2.2rem,4.4vw,3.8rem)] text-warm">
