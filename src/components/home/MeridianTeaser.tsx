...
export function MeridianTeaser() {
  return (
    <section id="platform" className="relative overflow-hidden border-y border-hairline bg-graphite py-28 md:py-40" data-section="MERIDIAN™">
      <div className="blueprint-grid absolute inset-0 opacity-70 [mask-image:radial-gradient(60%_80%_at_80%_50%,#000,transparent)]" />
      <SectionFrame tl="SEC 03" tr="PLATFORM" bl="MERIDIAN™ · v4.2" br="SPATIAL & ASSET INTELLIGENCE" />
      <div className="relative mx-auto grid max-w-7xl gap-14 px-6 md:grid-cols-12 md:px-10 lg:gap-10">
        <div className="md:col-span-6">
          ...
          <SplitText as="h2" text="MERIDIAN™" className="display mt-6 text-[clamp(3rem,6.4vw,6.4rem)]" />
          <SplitText
            as="p"
        ...
        <Reveal className="md:col-span-6" delay={0.2} y={40}>
          <div className="relative">
            <div className="pointer-events-none absolute -inset-6 -z-10 bg-[radial-gradient(60%_60%_at_50%_50%,rgba(244,242,237,0.04),transparent)]" />
