...
export function PageHero({ eyebrow, index, title, lede, ref_, children }: Props) {
  return (
    <section className="relative overflow-hidden pt-32 pb-16 md:pt-52 md:pb-28" data-section={eyebrow}>
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        ...
        <SplitText as="h1" text={title} className="display mt-8 max-w-5xl text-[clamp(2.15rem,7.5vw,7rem)]" immediate />
        {lede && (
